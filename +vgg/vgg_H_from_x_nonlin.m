...
% Make conditioners
C1 = vgg.vgg_conditioner_from_pts(p1);
C2 = vgg.vgg_conditioner_from_pts(p2);
...
H = inv(C2) * H_cond * C1;
rms = sqrt(vgg.vgg_H_sampson_distance_sqr(H,gp1,gp2));
...
function r = lsq_func(H)
  ...
  d = vgg.vgg_H_sampson_distance_sqr(H_decond,gp1,gp2);
